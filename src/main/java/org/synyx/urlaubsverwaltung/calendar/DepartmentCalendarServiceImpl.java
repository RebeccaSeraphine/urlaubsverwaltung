...
@Service
class DepartmentCalendarServiceImpl implements DepartmentCalendarService {
    ...
    @Autowired
    public DepartmentCalendarServiceImpl(AbsenceService absenceService, DepartmentService departmentService,
    ...
    @Override
    @Transactional
    public void deleteAllDepartmentsCalendarsForDepartment(int departmentId) {
        departmentCalendarRepository.deleteByDepartmentId(departmentId);
    }
